...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<BlindnessArrow>> BLINDING_ARROW = ENTITIES.register("blinding_arrow", () -> EntityType.Builder.<BlindnessArrow>of(BlindnessArrow::new, MobCategory.MISC).sized(0.5F,0.5F).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(HBM.MOD_ID, "blinding_arrow").toString()));
